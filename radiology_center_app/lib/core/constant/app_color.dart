...
const Color subtitleColor = Color(0xff677294);
const Color buttonBackground = Color(0xff0EBE7F);
const Color xIcon = Color(0xffFF0000);
const Color iconblue = Color(0xff2A7EFC);
...
const Color gradientGreen = Color(0xFFB2F7C2);
const Color gradientBlue = Color(0xFFB2F7EF);
